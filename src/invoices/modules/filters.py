...
def babel_currency(
    value: Any, currency: str = "CHF", locale: str = "de_CH", currency_format: Optional[str] = None
) -> str:
...
def babel_decimal(value: Any, locale: str = "de_CH", numeric_format: Optional[str] = None) -> str:
